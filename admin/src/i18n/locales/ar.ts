...
const ar = {
  ...
  agent: {
    ...
    models: "النماذج", modelsDesc: "سجل معرفات النماذج التي يستخدمها الوكلاء.", modelId: "معرف النموذج", displayName: "اسم العرض", noModels: "لا توجد نماذج.", "capability.text": "نص", "capability.image": "صورة", "capability.audio": "صوت", "capability.video": "فيديو", modelScenarios: "سيناريوهات النموذج", modelScenariosDesc: "اختر السيناريوهات المقصودة. اختبار التوفر اختياري.", verifiedScenariosLocked: "لا يمكن تغيير المزود أو معرف النموذج أو القدرات. أضف نموذجًا جديدًا لتغييرها.", transcriptionTestFile: "ملف صوتي للاختبار", videoTestUnavailable: "لا يوجد محول اختبار للفيديو بعد وسيظهر كغير متاح.", testingModel: "جارٍ الاختبار…", testAvailability: "اختبار التوفر", optionalTestDesc: "الاختبار منفصل عن الإضافة. يستدعي المزود الحقيقي وقد يسبب تكلفة، لكن نتيجته لا تؤثر في زر الإضافة.", modelTestsPassed: "نجحت جميع اختبارات السيناريوهات المحددة", modelTestsHaveFailures: "فشلت بعض الاختبارات؛ راجع النتائج أدناه", testPassed: "نجح", testFailed: "فشل", subscriptionAccess: "وصول الاشتراك", subscriptionAccessDesc: "اختر الخطط الحالية لجعل النموذج مخصصًا لها. اتركها دون تحديد ليكون متاحًا للمستخدمين العاديين.", subscriptionOnly: "للاشتراك فقط", standardUsers: "المستخدمون العاديون", noSubscriptionPlans: "لا توجد خطط اشتراك مهيأة.",
