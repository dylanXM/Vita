...
const ko = {
  ...
  agent: {
    ...
    models: "모델", modelsDesc: "컴패니언이 사용할 원격 모델 ID를 등록합니다.", modelId: "원격 모델 ID", displayName: "표시 이름", noModels: "설정된 모델이 없습니다.", "capability.text": "텍스트", "capability.image": "이미지", "capability.audio": "음성",
