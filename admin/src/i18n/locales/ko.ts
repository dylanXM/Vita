...
const ko = {
  ...
  agent: {
    ...
    models: "모델", modelsDesc: "컴패니언이 사용할 원격 모델 ID를 등록합니다.", modelId: "원격 모델 ID", displayName: "표시 이름", noModels: "설정된 모델이 없습니다.", "capability.text": "텍스트", "capability.image": "이미지", "capability.audio": "음성", "capability.video": "비디오", modelScenarios: "모델 시나리오", modelScenariosDesc: "모델이 지원할 시나리오를 선택합니다. 가용성 테스트는 선택 사항입니다.", verifiedScenariosLocked: "공급자, 모델 ID 및 기능은 변경할 수 없습니다. 변경하려면 새 모델을 추가하세요.", transcriptionTestFile: "테스트 오디오", videoTestUnavailable: "비디오 테스트 어댑터가 없어 현재 사용 불가로 표시됩니다.", testingModel: "테스트 중…", testAvailability: "가용성 테스트", optionalTestDesc: "테스트와 추가는 분리되어 있습니다. 실제 공급자 호출로 비용이 발생할 수 있지만 결과는 추가 버튼에 영향을 주지 않습니다.", modelTestsPassed: "선택한 모든 시나리오 테스트 통과", modelTestsHaveFailures: "일부 시나리오 테스트 실패. 아래 결과를 확인하세요", testPassed: "통과", testFailed: "실패", subscriptionAccess: "구독 전용", subscriptionAccessDesc: "기존 구독을 선택하면 해당 플랜 전용 모델이 됩니다. 선택하지 않으면 일반 사용자가 이용할 수 있습니다.", subscriptionOnly: "구독 전용", standardUsers: "일반 사용자", noSubscriptionPlans: "구독 플랜이 없습니다.",
