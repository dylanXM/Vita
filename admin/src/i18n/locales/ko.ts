...
const ko = {
  ...
  nav: {
    ...
    users: "사용자",
    companions: "캐릭터 관리",
    agent: "AI 컴패니언", mediaModels: "미디어 모델", invitationSettings: "초대 코드 설정",
  ...
  mediaModels: { title: "미디어 모델 라우팅", description: "각 미디어 동작에 선택적 기본 모델과 순서가 있는 대체 모델을 설정합니다.", save: "라우팅 저장", saved: "미디어 라우팅이 저장되었습니다", enabled: "동작 활성화", defaultModel: "기본 모델", fallbackModels: "대체 모델", addFallback: "대체 모델 추가", noFallback: "대체 모델이 없습니다.", notSelected: "선택 안 함", noCompatibleModels: "먼저 호환 모델을 만들고 활성화하세요.", "type.image": "이미지", "type.image.desc": "캐릭터의 생활을 기반으로 시각 콘텐츠를 생성합니다.", "type.audio": "오디오", "type.audio.desc": "사용자 음성을 이해하거나 캐릭터의 목소리를 생성합니다.", "type.video": "비디오", "type.video.desc": "선택적 생활 영상과 실시간 아바타 세션입니다.", "route.image_life_photo": "자동 생활 사진", "route.image_life_photo.desc": "발생한 Life 이벤트에서 사진을 생성합니다.", "route.image_requested_photo": "요청 사진", "route.image_requested_photo.desc": "현재 이벤트를 기반으로 유료 사진을 생성합니다.", "route.audio_transcription": "사용자 음성 인식", "route.audio_transcription.desc": "음성 메시지를 텍스트로 변환합니다.", "route.audio_speech": "캐릭터 음성 합성", "route.audio_speech.desc": "캐릭터 답장을 음성으로 변환합니다.", "route.video_life_clip": "Life 짧은 영상", "route.video_life_clip.desc": "Life 이벤트 비동기 영상용 예약 라우트입니다.", "route.video_realtime_avatar": "실시간 비디오 아바타", "route.video_realtime_avatar.desc": "실시간 아바타 및 영상 통화용 예약 라우트입니다." },
