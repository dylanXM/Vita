...
const ja = {
  ...
  agent: {
    ...
    models: "モデル", modelsDesc: "コンパニオンが利用するモデルIDを登録します。", modelId: "モデルID", displayName: "表示名", noModels: "モデルがありません。", "capability.text": "テキスト", "capability.image": "画像", "capability.audio": "音声", "capability.video": "動画", modelScenarios: "モデルシーン", modelScenariosDesc: "モデルが対応予定のシーンを選択します。可用性テストは任意です。", verifiedScenariosLocked: "プロバイダー、モデルID、機能は変更できません。変更する場合は新しいモデルを追加してください。", transcriptionTestFile: "テスト音声", videoTestUnavailable: "動画テストアダプターは未実装で、現在利用不可と表示されます。", testingModel: "テスト中…", testAvailability: "可用性をテスト", optionalTestDesc: "テストと追加は独立しています。実プロバイダーを呼ぶため料金が発生する場合がありますが、結果は追加ボタンに影響しません。", modelTestsPassed: "選択したすべてのシーンでテスト成功", modelTestsHaveFailures: "一部のシーンでテスト失敗。下の結果を確認してください", testPassed: "成功", testFailed: "失敗", subscriptionAccess: "サブスクリプション限定", subscriptionAccessDesc: "既存プランを選ぶと、そのプラン専用モデルになります。未選択なら一般ユーザーが利用できます。", subscriptionOnly: "プラン限定", standardUsers: "一般ユーザー", noSubscriptionPlans: "サブスクリプションプランがありません。",
