import { Bot, Coins, CreditCard, HeartHandshake, ImagePlay, LayoutDashboard, Megaphone, PanelsTopLeft, PawPrint, ReceiptText, ScrollText, Share2, ShoppingBag, UserPlus, Users, type LucideIcon } from "lucide-react";
