...
func Load() *Config {
	return &Config{
		...
		DBDSN:           getEnv("TOVIDEO_DB_DSN", "postgres://tovideo:tovideo_dev_password@localhost:5432/vita?sslmode=disable"),
		RedisURL:        getEnv("TOVIDEO_REDIS_URL", "redis://localhost:6379/0"),
